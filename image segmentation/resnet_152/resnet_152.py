...
#-------------------------------------------------------------------------------------------------------------------------------------------
model = models.resnet152(pretrained=True)       #depending on the model change models.<name>
_ = model.eval()
#-------------------------------------------------------------------------------------------------------------------------------------------
...
torch.onnx._export(model, x, f'resnet152.onnx', export_params=True)   #convert model name as <name>.onnx
print(f"See in the folder we have a resnet152.onnx file")
print("-"*70)
#------------------------------------------------------------------------------------------------------------------------------------------
...
model_xml="resnet152.xml"
model_bin = "resnet152.bin"
#model_xml, model_bin
