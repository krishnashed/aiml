...
#-------------------------------------------------------------------------------------------------------------------------------------------
model = models.inception_v3(pretrained=True)       #depending on the model change models.<name>
_ = model.eval()
#-------------------------------------------------------------------------------------------------------------------------------------------
...
torch.onnx._export(model, x, f'inception_v3.onnx', export_params=True)   #convert model name as <name>.onnx
print(f"See in the folder we have a inception_v3.onnx file")
print("-"*70)
#------------------------------------------------------------------------------------------------------------------------------------------
...
model_xml="inception_v3.xml"
model_bin = "inception_v3.bin"
#model_xml, model_bin
...
out = exec_net.infer(inputs={"x.1": x})
