...
#-------------------------------------------------------------------------------------------------------------------------------------------
model = models.vgg19(pretrained=True)       #depending on the model change models.<name>
_ = model.eval()
#-------------------------------------------------------------------------------------------------------------------------------------------
...
torch.onnx._export(model, x, f'vgg19.onnx', export_params=True)   #convert model name as <name>.onnx
print(f"See in the folder we have a vgg19.onnx file")
print("-"*70)
#------------------------------------------------------------------------------------------------------------------------------------------
