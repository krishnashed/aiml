...
#-------------------------------------------------------------------------------------------------------------------------------------------
model = models.vgg16(pretrained=True)       #depending on the model change models.<name>
_ = model.eval()
#-------------------------------------------------------------------------------------------------------------------------------------------
...
torch.onnx._export(model, x, f'vgg16.onnx', export_params=True)   #convert model name as <name>.onnx
print(f"See in the folder we have a vgg16.onnx file")
print("-"*70)
#------------------------------------------------------------------------------------------------------------------------------------------
