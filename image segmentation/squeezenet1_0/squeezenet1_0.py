...
#-------------------------------------------------------------------------------------------------------------------------------------------
model = models.squeezenet1_0(pretrained=True)       #depending on the model change models.<name>
_ = model.eval()
#-------------------------------------------------------------------------------------------------------------------------------------------
...
torch.onnx._export(model, x, f'squeezenet1_0.onnx', export_params=True)   #convert model name as <name>.onnx
print(f"See in the folder we have a squeezenet1_0.onnx file")
print("-"*70)
#------------------------------------------------------------------------------------------------------------------------------------------
...
model_xml="squeezenet1_0.xml"
model_bin = "squeezenet1_0.bin"
#model_xml, model_bin
